...
<template>
    ...
    <router-link to="/campaign-reports/">Campaign Reports</router-link>
                    ...
                    <MenuItems
                        ...
                        <div class="py-1">
                            <MenuItem v-slot="{ active }">
                                ...
                                " class="flex justify-between w-full px-4 py-2 text-sm leading-5 text-left" to="/">
                                    Home
                                </router-link>
                            </MenuItem>
                            <MenuItem v-slot="{ active }">
